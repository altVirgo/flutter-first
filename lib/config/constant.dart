...
class Constant {
  ...
  static TextStyle searchTextFiledStyle =
      TextStyle(fontSize: 26.sp, color: const Color(0xff051220));

  static TextStyle searchTextFieldHintStyle =
      TextStyle(fontSize: 26.sp, color: const Color(0xff979DA3));
