...
import 'package:flutter_first/config/constant.dart';
...
class CommonWidget {
        ...
        children: [
          ...
          Container(
              ...
              child: InkWell(
                ...
                child: const Text(
                  '搜索',
                  style: TextStyle(color: Color(0xff051220)),
                ),
              ))
        ],
      ),
  ...
  static Widget dividerWidget(
      {double? dividerHeight, int dividerColor = 0xfff0f0f0}) {
    dividerHeight ??= 1.w;
    return Divider(
  ...
  static Widget listTile(
      {Widget? leading,
      Color leadingBackgroundColor = const Color.fromRGBO(88, 202, 147, 1),
      String? tipNum,
                    ...
                    ? Column(
                        ...
                        children: [
                          Text(
                            title,
                            style: TextStyle(
                                color: const Color.fromRGBO(32, 35, 40, 0.8),
                                fontSize: 30.sp),
                          ),
                          SizedBox(
                            height: 10.w,
          ...
          Container(
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 22.sp,
                    color: const Color.fromRGBO(32, 35, 40, 1)),
              ),
            ),
          )
        ],
            ...
            children: [
              ...
              ListTile(
                contentPadding:
                    EdgeInsets.only(top: 8.w, left: -25.w, right: -25.w),
                leading:
                    imageWidget(imageUrl: leadingUrl, hasDefault: hasDefault),
                title: desc != null
                    ? Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
  ...
  static Widget imageWidget(
    ...
    if (imageUrl != null &&
        imageUrl != '' &&
        StringUtil.isNetWorkImg(imageUrl)) {
      return ClipRRect(
  ...
  /// @param {Function} callBack 回调
  static Widget simpleWidgetWithUserDetail(String title,
      {String? value, bool isImage = false, Function? callBack}) {
    Widget child;
    if (isImage) {
      if (callBack == null) {
        child = CommonWidget.imageWidget(
            imageUrl: value, hasDefault: true, width: 60.w, height: 60.w);
      } else {
        child = Row(
          children: [
      ...
      if (callBack == null && value != null) {
        child = Text(
          value,
          style: const TextStyle(color: Color.fromRGBO(144, 147, 153, 1)),
        );
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Text(
                  title,
                  style: const TextStyle(color: Color.fromRGBO(80, 82, 86, 1)),
                ),
              ),
  ...
  static Widget buttonWidget(
      {String title = '提交',
      Color background = const Color.fromRGBO(41, 121, 255, 1),
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          title,
          style: TextStyle(fontSize: 32.sp, color: fontColor),
        ),
      ),
    );
  }
  ...
  /// @param {String} trailingTitle 右侧显示
  /// @param {Function} onclick 点击回调函数
  static Widget listTileWithMine(
      {Widget? leading,
      Color leadingBackgroundColor = const Color.fromRGBO(88, 202, 147, 1),
      required String title,
      String? desc,
